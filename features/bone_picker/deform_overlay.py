...
# core/facade/README.md) from set_holding() below, instead of this module
...
_HUD_SLOT = 2  # third row from the anchor -- see core/facade/README.md's reserved-slot table
