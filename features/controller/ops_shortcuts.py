...
bound to Alt+1) was removed -- Alt+1 now toggles Mask Mode instead
(`features/deform_layer_viewer/deform_bone_viewer/keymap.py`), and the shortcut-overlay HUD
toggle that briefly sat on Alt+1 has since moved to Alt+4 (see
`interface/utils/shortcut_overlay.py`). The individual
