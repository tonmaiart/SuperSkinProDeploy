...
there is no active mesh object. This popup is reachable from the
always-visible "How to use" toggle in panel_main.py, which explicitly needs
no activation gate -- the guide must keep working precisely when a new user
has neither activated the license nor selected a mesh yet. See
docs/domains/builtin_tutorial.md "Why no dispatch actions".
"""
