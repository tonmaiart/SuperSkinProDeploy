...
ordinary same-package import, instead of crossing the cross-domain import
boundary that would otherwise apply to a sibling `features/*` package. See
`docs/domains/weight_apply.md`'s "Weight Brush" section for the full
rationale and dataflow.
...
#   - `features/skin_tools_ui/ui_weight_apply.py`'s draw_section() (skips
#     draw_tool_row())
