...
Owns:
  ...
  - UI layout: moved to features/skin_tools_ui/ui_auto_block.py, then
    folded into features/skin_tools_ui/ui_action_grid.py's combined grid
    (see docs/domains/skin_tools_ui.md) — draw_section() here is a stub
...
class AutoBlockFeature(UnifiedFeatureExtension):
    ...
    def execute(self, action: str, context, core_facade: CoreFacade) -> dict:
        ...
        # `dirty_verts` contract in `docs/core-interfaces/facade-api.md`.
