...
class SUPERSKIN_OT_grow_shrink_selection(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        # SUPERSKIN_OT_safe_shrink, formerly in features/controller/ops_tools.py,
        # removed 2026-09-16 as dead code once this operator superseded it)
        # only reproduces Blender's native single-vertex protection. It does
        # nothing for a vertex loop:
