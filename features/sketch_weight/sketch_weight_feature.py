...
Owns:
  ...
  - UI layout: moved to features/skin_tools_ui/ui_sketch_weight.py (see
    docs/domains/skin_tools_ui.md) — draw_section() here is a stub
...
class SketchWeightFeature(UnifiedFeatureExtension):
    ...
    def draw_section(self, layout, context) -> None:
        """UI moved to features/skin_tools_ui/ui_sketch_weight.py — see
