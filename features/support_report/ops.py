...
docs/domains/support_report.md "Why no dispatch actions".
"""
...
class SUPERSKIN_OT_export_support_report(bpy.types.Operator):
    ...
    timestamped JSON file under a per-user support_reports/ folder (outside
    the addon's own installed directory -- see CoreFacade.get_dev_output_dir()),
    copy the path to the clipboard, and open its containing folder."""
