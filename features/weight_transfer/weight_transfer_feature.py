...
# docs/domains/tool_socket.md's plug-in contract ("a tool plugged into the
...
class WeightTransferFeature(UnifiedFeatureExtension):
    ...
    draw_tab = "LAYER_SOCKET"  # plugged into tool_socket's LAYER dropdown, see docs/domains/tool_socket.md
