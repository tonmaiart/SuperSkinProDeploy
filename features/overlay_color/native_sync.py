...
this reason once before — see docs/domains/overlay_color.md's "History" section), so this
...
# Black -> deep berry -> neon pink -> pastel pink -> white. The two
# intermediate stops exist to keep the ramp perceptually vibrant across a
# straight RGB lerp: without them, black->pink muddies into gray-brown
# through its own midpoint, and pink->white bleaches out too quickly.
_MASK_RAMP_STOPS = [
    ...
    (1.00, (0xFF / 255, 0xFF / 255, 0xFF / 255)),  # #FFFFFF white
]
