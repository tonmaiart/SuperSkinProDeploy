...
``core/facade/README.md``), used instead of this module owning its own
...
_HUD_SLOT = 1  # second row from the anchor -- see core/facade/README.md's reserved-slot table
