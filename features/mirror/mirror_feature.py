...
class MirrorAllLayersFeature(UnifiedFeatureExtension):
    ...
    **Deliberately plugged into LAYER_SOCKET, not SKINNING_SOCKET** — the
    ...
    Blender's native Object/Edit mode toggle — see `interface/README.md`'s
    ...
    every mode (`interface/README.md` again), so LAYER_SOCKET is the tab
    ...
    draw_tab = "LAYER_SOCKET"  # plugged into tool_socket's LAYER dropdown, see features/tool_socket/README.md -- Object-Mode-only, see class docstring
    link = "https://docs.superskinpro.com/mirror_tab/"
