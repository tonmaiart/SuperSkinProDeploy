...
(``priority = 9999``, a reserved sort-last sentinel -- see docs/domains/tool_socket.md). There
...
class ToolSocketFeature(UnifiedFeatureExtension):
    ...
    def draw_section_for_tab(self, layout, context, tab_key: str) -> None:
        ...
        # here doesn't violate docs/core-interfaces/interface.md's closed-subsystem
