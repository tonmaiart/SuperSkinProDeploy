...
# core_subsystems/layer_compositor/__init__.py's comment for the "Reload-
# Ordering Footgun" this avoids (binding before reload permanently captures a
# stale, pre-reload class object on every F3 Reload Scripts after the first).
