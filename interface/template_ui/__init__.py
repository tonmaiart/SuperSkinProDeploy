...
Exports (public):
    ...
    draw_lists_side_by_side     - layout helper (two draw_list_with_sidebar-based lists, equal-width, side by side)
    ...
    is_double_click             - shared double-click-on-a-row detection (per domain key)
    reset_double_click          - clear a domain's tracked double-click state
"""
