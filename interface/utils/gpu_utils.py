...
BONE_COLORS = (
    (0.90, 0.10, 0.15),  # 1. Deep Red
    (0.10, 0.85, 0.25),  # 2. Bright Emerald Green
    (0.10, 0.15, 0.70),  # 3. Deep Royal Blue
    (1.00, 0.90, 0.10),  # 4. High-key Yellow
    (0.85, 0.15, 0.75),  # 5. Bright Magenta
    (0.10, 0.90, 0.95),  # 6. Bright Cyan
    (0.95, 0.45, 0.05),  # 7. Vibrant Orange
    (0.35, 0.10, 0.50),  # 8. Dark Violet
    (0.65, 0.95, 0.10),  # 9. Neon Lime
    (0.05, 0.40, 0.65),
)
