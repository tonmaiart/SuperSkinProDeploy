...
def register():
    ...
    # 1. Foundations
    utils.register()
    # utils.shortcut_overlay.register_overlay()  # TEMPORARILY DISABLED -- Alt+1 shortcut-hint HUD
...
def unregister():
    ...
    # utils.shortcut_overlay.unregister_overlay()  # TEMPORARILY DISABLED -- see register() above
    utils.unregister()
